...
<div class="act pbm cl">
	...
	<div class="spi">
		<dl>
			<dd class="deanhd_types">{lang activity_type}:<em>$activity[class]</em></dd>
			<dd class="deanhd_starttime">
			...
			<dd class="deanhd_addressed">
				{lang activity_space}:<em>$activity[place]</em>
			</dd>
			<dd class="deanhd_genders">
            	{lang gender}:
                <em>
            ...
            <dd class="deanmageshds">
                <div class="deanhdmagtxt">{lang activity_already}:</div>
                <div class="deanhdnumeds">
    ...
    <div class="deanhdenter_btn">
        <!--{if $post['invisible'] == 0}-->
            ...
            <!--{elseif !$activityclose}-->
                <p class="deanenterhd_pns">
                    <!--{if $isverified != 2}-->
                        <!--{if !$activity['number'] || $aboutmembers > 0}--><button class="dean_pn" value="true" name="ijoin" onclick="{if $_G['uid']}showDialog($('activityjoin').innerHTML, 'info', '{lang activity_join}'){else}showWindow('login', 'member.php?mod=logging&action=login&guestmessage=yes'){/if}"><span>{lang activity_join}</span></button><!--{/if}-->
                    <!--{else}-->
