	...
	<script type="text/javascript">
		...
		<!--{if $threadlist}-->
			...
			<!--{loop $threadlist $thread}-->
				...
				newthread[{$i}] = {'tid':$thread[tid], 'thread': {'icn':{'className':'icn','val':'<div class="dean_forumlistava"><!--{if $thread['authorid'] && $thread['author']}--><a href="home.php?mod=space&uid=$thread[authorid]" c="1"><!--{avatar($thread[authorid],small)}--></a><!--{else}-->
