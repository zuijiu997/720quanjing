...
<div class="deansortmods">
	<div class="deansmbgsd">
        <div class="deansortmains">
            <div id="pt" class="bm cl" style="padding:10px 0; margin:0;">
                <div class="z">
...
<div id="ct" class="wp cl {if $close_leftinfo} ct2{/if}">
    ...
    <div class="mn" <!--{if !$close_leftinfo}--> style="width:100%">
    	
        <div class="deanfbhf">
                <a class="deanfabuanniu" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=$_G[fid]')" href="javascript:;" title="{lang send_posts}">发布主题</a>
            <!--{if $allowpostreply && !$_G['forum_thread']['archiveid']}-->
                <a class="deanpostreply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]')" href="javascript:;" title="{lang reply}">回复</a>
            <!--{/if}-->
                <div class="clear"></div>
            </div>
        <!--{/if}-->
    ...
    <div id="postlist" class="pl bm {if !$close_leftinfo}deanconone{else}deanothers{/if}">
    ...
    <div class="pgs mtm mbm cl">
        ...
        <!--{if !$_G['forum_thread']['is_archived']}-->
            <a class="deanfabuanniu" {if !$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']} onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=$_G[fid]')"{else} onclick="location.href='forum.php?mod=post&action=newthread&fid=$_G[fid]';return false;"{/if} href="javascript:;" title="{lang send_posts}">发表新帖</a>
        <!--{/if}-->
        <!--{if $allowpostreply && !$_G['forum_thread']['archiveid']}-->
            <a class="deanpostreply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]')" href="javascript:;" title="{lang reply}">回复</a>
        <!--{/if}-->
	...
	<div class="sd">
		<!--{if $modmenu['thread']}-->
		<div class="deansdpart">
		<a href="javascript:;" id="deanguanli" onmouseover="showMenu({'ctrlid':'deannew_guanli'});">管理</a>
			<!--{if $modmenu['thread']}-->
				<div id="deannew_guanli_menu" class="p_pop kmp_pop" style="display: none;">
					<!--{eval $modopt=0;}-->
					<!--{if $_G['forum']['ismoderator']}-->
		...
		<a class="deanfabu" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=$_G[fid]')" href="javascript:;" title="{lang send_posts}">发布主题</a>
        <!--推荐阅读-->
            <div class="deansidebox">
                ...
                <div class="deantuijianbox">
                    <!--[diy=deantuijianbox]--><div id="deantuijianbox" class="area"></div><!--[/diy]-->
                    
                </div>
                <div class="deansdlists">
                    <ul>
                        <!--[diy=deansdlists]--><div id="deansdlists" class="area"></div><!--[/diy]-->
            ...
            <div class="deansidebox" style="margin-bottom:10px;">
                ...
                <div class="deanranklistbox">
                    <ul>
                        <!--[diy=deanranklistbox]--><div id="deanranklistbox" class="area"></div><!--[/diy]-->
                    </ul>
                </div>
                <script type="text/javascript">
