...
0
|| checktplrefresh('./template/dean_cg_160522/common/header.htm', './template/default/common/header_common.htm', 1512701064, '6', './data/template/6_6_common_header_plugin_dc_signin.tpl.php', './template/dean_cg_160522', 'common/header_plugin_dc_signin')
|| checktplrefresh('./template/dean_cg_160522/common/header.htm', './template/default/common/header_qmenu.htm', 1512701064, '6', './data/template/6_6_common_header_plugin_dc_signin.tpl.php', './template/dean_cg_160522', 'common/header_plugin_dc_signin')
|| checktplrefresh('./template/dean_cg_160522/common/header.htm', './template/dean_cg_160522/common/pubsearchform.htm', 1512701064, '6', './data/template/6_6_common_header_plugin_dc_signin.tpl.php', './template/dean_cg_160522', 'common/header_plugin_dc_signin')
;?>
...
<?php } ?>
<link href="<?php echo $_G['style']['styleimgdir'];?>/main.css" type="text/css" rel="stylesheet" />
    <link href="<?php echo $_G['style']['styleimgdir'];?>/a.css" type="text/css" rel="stylesheet" />
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery-1.8.3.min.js" type="text/javascript"></script>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery.bxslider.js" type="text/javascript"></script>   
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/jPages.js" type="text/javascript"></script>
    
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/wow.min.js" type="text/javascript"></script>
    <script type="text/javascript">
        var jq=jQuery.noConflict();
    </script>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/kefu.js" type="text/javascript"></script>
    <script type="text/javascript">
    	 jq(function() {
...
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra2'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra2'];?><?php if(is_array($_G['setting']['topnavs']['1'])) foreach($_G['setting']['topnavs']['1'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } if(empty($_G['disabledwidthauto']) && $_G['setting']['switchwidthauto']) { } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onMouseOver="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">切换风格</a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
</div>
...
<?php if(!empty($_G['setting']['pluginhooks']['global_qmenu_bottom'])) echo $_G['setting']['pluginhooks']['global_qmenu_bottom'];?>
        ...
        <div class="deannavwrap" id="deanheader">
        	<div class="deanw1180">
                ...
                <?php $mnid = getcurrentnav();?>                <div class="deannav">
                    <ul>
...
<ul id="scbar_type_menu" class="p_pop" style="display: none; top:47px!important;"><?php echo implode('', $slist);; ?></ul>
<script type="text/javascript">
...
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/nv1.js" type="text/javascript"></script>
        <div class="clear"></div>
