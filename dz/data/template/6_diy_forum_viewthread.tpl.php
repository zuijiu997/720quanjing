...
0
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1512691919, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1512691919, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1512691919, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/viewthread.htm', './template/default/common/seditor.htm', 1512691919, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1512691919, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/viewthread.htm', './template/default/common/upload.htm', 1512691919, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/viewthread.htm', './template/default/common/seccheck.htm', 1512691919, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/viewthread')
;
block_get('517,518,519,516');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<!--[diy=deanad]--><div id="deanad" class="area"><div id="frameZvpqhi" class="frame move-span cl frame-1"><div id="frameZvpqhi_left" class="column frame-1-c"><div id="frameZvpqhi_left_temp" class="move-span temp"></div><?php block_display('517');?></div></div></div><!--[/diy]-->
</div>
<style type="text/css">
...
<div class="deanbangc">
    	<div class="deanbangl wow bounceInLeft">
        	<ul><!--[diy=deanbangl]--><div id="deanbangl" class="area"><div id="frameA6VxG9" class="frame move-span cl frame-1"><div id="frameA6VxG9_left" class="column frame-1-c"><div id="frameA6VxG9_left_temp" class="move-span temp"></div><?php block_display('518');?></div></div></div><!--[/diy]--></ul>
        </div>
        <div class="deanbangr"><ul><!--[diy=deanbangr]--><div id="deanbangr" class="area"><div id="frameIYkrij" class="frame move-span cl frame-1"><div id="frameIYkrij_left" class="column frame-1-c"><div id="frameIYkrij_left_temp" class="move-span temp"></div><?php block_display('519');?></div></div></div><!--[/diy]--></ul></div>
        <div class="clear"></div>
    </div>
</div>
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { } } if($allowpostreply && !$_G['forum_thread']['archiveid']) { } ?>
...
<div class="deanbuttonpost">
    ...
    <a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" class="button13" title="发新帖">发布主题</a>
    <?php } ?>
    <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?><a  class="button13" id="post_replytmp" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a><?php } ?>
<div class="clear"></div>
</div>
...
<?php } ?>
    <div class="clear"></div>
    <?php if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { $nxtpage = $page + 1;?><div class="pgbtn deannext"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true" class="bm_h">下一页 &raquo;</a></div>
<?php } ?>
<div class="clear"></div>
...
<div class="deanvh3"><span>精彩图文</span></div>
    ...
    <ul class="deantabul">
        <li style="display:block;">
            <dl><!--[diy=deantabul]--><div id="deantabul" class="area"><div id="framehMGEvj" class="frame move-span cl frame-1"><div id="framehMGEvj_left" class="column frame-1-c"><div id="framehMGEvj_left_temp" class="move-span temp"></div><?php block_display('516');?></div></div></div><!--[/diy]--><div class="clear"></div></dl>
        </li>
</ul>
</div>
...
<div class="clear"></div>
<?php if($modmenu['thread']) { ?>
<div class="xi2 mbm pbm bbs"  style="display:none;">
<script type="text/javascript">
