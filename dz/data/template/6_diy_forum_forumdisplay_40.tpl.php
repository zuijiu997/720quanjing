<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forumdisplay_40');
0
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/forumdisplay_40.htm', './template/default/forum/forumdisplay_leftside.htm', 1512667088, 'diy', './data/template/6_diy_forum_forumdisplay_40.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/forumdisplay_40')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/forumdisplay_40.htm', './template/default/forum/recommend.htm', 1512667088, 'diy', './data/template/6_diy_forum_forumdisplay_40.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/forumdisplay_40')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/forumdisplay_40.htm', './template/default/common/seccheck.htm', 1512667088, 'diy', './data/template/6_diy_forum_forumdisplay_40.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/forumdisplay_40')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/forumdisplay_40.htm', './template/dean_cg_160522/forum/forumdisplay_list.htm', 1512667088, 'diy', './data/template/6_diy_forum_forumdisplay_40.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/forumdisplay_40')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/forumdisplay_40.htm', './template/default/forum/forumdisplay_sort.htm', 1512667088, 'diy', './data/template/6_diy_forum_forumdisplay_40.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/forumdisplay_40')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/forumdisplay_40.htm', './template/default/forum/search_sortoption.htm', 1512667088, 'diy', './data/template/6_diy_forum_forumdisplay_40.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/forumdisplay_40')
|| checktplrefresh('data/diy/./template/dean_cg_160522//forum/forumdisplay_40.htm', './template/default/forum/search_sortoption.htm', 1512667088, 'diy', './data/template/6_diy_forum_forumdisplay_40.tpl.php', 'data/diy/./template/dean_cg_160522/', 'forum/forumdisplay_40')
...
<div class="deanforumjsc">
        <div class="deanjstop">
            <?php if($_G['forum']['banner'] && !$subforumonly) { ?><div class="deanjstopl"><img src="<?php echo $_G['forum']['banner'];?>" alt="<?php echo $_G['forum']['name'];?>" /></div><?php } ?>
            <div class="deanjstopr">
            	<div class="deanhhhh">
                    <h3><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><?php echo $_G['forum']['name'];?></a></h3>
                    <p><span>今日</span><em><?php echo $_G['forum']['todayposts'];?></em></p>
                    <p><span>主题</span><em><?php echo $_G['forum']['threads'];?></em></p>
                    <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum" id="a_favorite" class="deansc" onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版 <strong class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>><span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span></strong></a>
            ...
            <?php if(!$_GET['archiveid']) { ?><div class="deanqd"><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><span>发布主题</span></a></div><?php } ?>
            <div class="clear"></div>
        </div>
    </div>
</div>
...
<div id="ct" class="wp cl<?php if($_G['forum']['allowside']) { ?> ct2<?php } ?>"<?php if($leftside) { ?> style=""<?php } ?>>
<?php if($leftside) { ?>
...
<?php } } ?>
    <div class="deanselect">
        ...
        <div class="deanselectbox deanselect3"><a id="filter_dateline" href="javascript:;" class="showmenu xi2<?php if($_GET['dateline']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">更多</a></div>
        
        <div class="deanselecty">
        	<span id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="y atarget_1"<?php } else { ?>onclick="setatarget(1)" class="y"<?php } ?> title="在新窗口中打开帖子">新窗</span><em>|</em>
        	<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=lastpost&amp;orderby=lastpost<?php echo $forumdisplayadd['lastpost'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'lastpost') { ?> xw1<?php } ?>">最新</a><em>|</em>
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=heat&amp;orderby=heats<?php echo $forumdisplayadd['heat'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'heat') { ?> xw1<?php } ?>">热门</a><em>|</em>
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="xi2<?php if($_GET['filter'] == 'hot') { ?> xw1<?php } ?>">热帖</a><em>|</em>
            ...
            <?php } else { ?>
                <a<?php if(empty($_G['cookie']['forumdefstyle'])) { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=yes" class="chked"<?php } else { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=no" class="unchk"<?php } ?> title="图片模式浏览帖子" style=" margin-right:10px; margin-top:3px;">图片模式</a>
...
<th class="<?php echo $thread['folder'];?>">
                                    	<div class="deanflists">
                                            <div class="deanflistname">
                                                <?php echo $thread['typehtml'];?> <?php echo $thread['sorthtml'];?><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?><?php if($thread['isgroup'] == 1 || $thread['forumstick']) { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> class="s xst"><?php echo $thread['subject'];?></a>
...
<?php if($thread['moved']) { ?>
移动:<?php $thread[tid]=$thread[closed];?><?php } if($_G['setting']['threadhidethreshold'] && $thread['hidden'] >= $_G['setting']['threadhidethreshold']) { ?><span class="xg1">隐藏</span>&nbsp;<?php } if($thread['icon'] >= 0) { ?>
...
<?php } } ?>
                                            ...
                                            <div class="deanflistinfo">
                                                <div class="deanfby1">
                                                    ...
                                                    <?php if($thread['authorid'] && $thread['author']) { ?>
                                                        楼主：<a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1"<?php if($groupcolor[$thread['authorid']]) { ?> style="color: <?php echo $groupcolor[$thread['authorid']];?>;"<?php } ?>><?php echo $thread['author'];?></a><?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } ?>
                                                    <?php } else { ?>
                                                ...
                                                <b class="deanb">|</b>
                                                <div class="deanfby2">
                                                    最后发表: <?php if($thread['lastposter']) { ?><a href="<?php if($thread['digest'] != -2) { ?>home.php?mod=space&username=<?php echo $thread['lastposterenc'];?><?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>&page=<?php echo max(1, $thread['pages']);; } ?>" c="1"><?php echo $thread['lastposter'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?>
                                    	...
                                    	<div class="deanfnums">
                                        	<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" class="xi2"><?php echo $thread['allreplies'];?></a>
                                        	<em><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></em>
                                            <div class="clear"></div>
                                        </div>
                                    	<div class="clear"></div>
...
<ul id="waterfall" class="ml waterfall cl deantabc"><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { if($thread['related_group'] == 0 && $thread['closed'] > 1) { $thread[tid]=$thread[closed];?><?php } } $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth] + 24;?><li>
                                <div class="clear"></div>
<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
<div style="position:absolute;margin:1px;padding:2px;z-index:2;">
<?php if($thread['fid'] == $_G['fid']) { if($thread['displayorder'] <= 3 || $_G['adminid'] == 1) { ?>
<input onclick="tmodclick(this)" type="checkbox" name="moderate[]" value="<?php echo $thread['tid'];?>" />
<?php } else { ?>
<input type="checkbox" disabled="disabled" />
...
<?php } ?>
                                    ...
                                    <h3><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?><?php if($thread['isgroup'] == 1 || $thread['forumstick']) { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> title="<?php echo $thread['subject'];?>" style="display:block; height:40px; overflow:hidden;"><?php echo $thread['subject'];?></a></h3>
                                </div>
<div class="clear"></div>
                                <div class="deanddinfo">
                                    ...
                                    <div class="clear"></div>
                                    <div class="deanddnum">
                                        <b class="deansee" title="播放量"><?php echo $thread['views'];?></b>
                                        <em class="deancomment" title="评论数"><?php echo $thread['replies'];?></em>
                                        <a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" target="_blank" style="color:#99a2aa;">作者：<?php echo $thread['author'];?></a>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="clear"></div>
                                  </div>
