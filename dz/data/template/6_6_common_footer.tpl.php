...
<div class="deanfooter">
    	<div class="deanfttop">
        	<div class="deanw1180">
                <div class="deanftdiv">
                    ...
                    <div class="clear"></div>
                    <span style="color:#999;">18990183328</span>
                </div>
        ...
        <div class="deanftbottom">
        	<div class="deanw1180">
                ...
                <div class="deanftbottomr"><p>Copyright &nbsp;&nbsp;&copy;2015-2016&nbsp;&nbsp;<a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a>&nbsp;&nbsp;Powered by&copy;<a href="http://www.discuz.net" target="_blank">Discuz!</a>&nbsp;&nbsp;技术支持：<a href="#" target="_blank">迪恩网络</a>&nbsp;&nbsp;<?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } ?>&nbsp;&nbsp;<?php if($_G['setting']['icp']) { ?>( <a href="http://www.miitbeian.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a> )<?php } ?></p></div>
