<?php /* Smarty version Smarty-3.1.7, created on 2017-11-12 08:35:17
         compiled from "C:/PHPWAMP_IN1/wwwroot/720quanjing/template\zz_theme\member\project.lbi" */ ?>
<?php /*%%SmartyHeaderCode:252735a0797459ebfc7-81482154%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '205dfd2a5fc3a0b3b9708fa06f6c6697b0b79d04' => 
    array (
      0 => 'C:/PHPWAMP_IN1/wwwroot/720quanjing/template\\zz_theme\\member\\project.lbi',
      1 => 1478323762,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '252735a0797459ebfc7-81482154',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a079745a78f0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a079745a78f0')) {function content_5a079745a78f0($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['_lang']->value['moban'])."/library/member_paths.lbi", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
			  ...
			  '<div class="item">'+
			    '<div class="item-content">'+
			    	...
			    	'<div class="pull-right works_edit">'+
			    		'<span>排序：<a id="sort_1_'+o.pk_works_main+'" onclick="sort('+o.pk_works_main+','+o.user_sort+',1)">'+o.user_sort+'</a></span>'+
			    	    '<span>是否推荐：<a id="recommend_1_'+o.pk_works_main+'" onclick="tuijian('+o.pk_works_main+',1)" data-recommend="'+o.user_recommend+'">'+(o.user_recommend==0?"<i class=\"icon-times\"></i>":"<i class=\"icon-check\" style=\"color:#c40000\"></i>")+'</a></span>'+
			  ...
			  '<div class="item">'+
			    '<div class="item-content">'+
			    	...
			    	'<div class="pull-right works_edit">'+
			    		...
			    		'<span><a onclick="fenxiang(\''+cdn_host+'video/play.html?vid='+o.id+'\')">分享</a></span>'+
...
function fenxiang(viewid){
	var text =  "http://" + window.location.host +"/tour/"+viewid;
	$("#fx_img").attr("src","/qrcode.php?viewid="+viewid);
	$("#fx_modal").modal("show");
